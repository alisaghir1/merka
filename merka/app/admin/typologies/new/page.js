...
export default function NewTypologyPage() {
  ...
  const [formData, setFormData] = useState({
    title: '', slug: '', icon: '🏢', gradient: 'from-blue-600 to-blue-800',
    short_description: '', description: '', extended_description: '',
    features: [], considerations: [], regulations: [],
    images: { hero: '', gallery: [] },
    display_order: 0, published: false, meta_title: '', meta_description: ''
  })
  const [inputValues, setInputValues] = useState({ features: '', considerations: '', regulations: '' })
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-6">
          {['features', 'considerations', 'regulations'].map(field => (
