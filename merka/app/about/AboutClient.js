    ...
    <div className={`min-h-screen bg-white overflow-x-hidden ${isRTL ? 'rtl' : ''}`}>
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 pointer-events-none">
          ...
          >
            <div className={`bg-white/95 backdrop-blur-md p-8 rounded-3xl shadow-2xl border border-white/50 ${isRTL ? 'text-right' : ''}`}>
              ...
              <div className={`flex flex-col sm:flex-row gap-4 justify-center ${isRTL ? 'sm:flex-row-reverse' : ''}`}>
                <a href="#founding-story" className={`group bg-[#041533] text-white px-8 py-4 rounded-2xl font-semibold shadow-xl hover:bg-[#877051] hover:scale-105 hover:shadow-2xl transition-all duration-300 flex items-center justify-center gap-2 ${isRTL ? 'flex-row-reverse' : ''}`}>
                  {t('common.readOurStory')}
                  <svg className={`w-5 h-5 group-hover:translate-x-1 transition-transform duration-300 ${isRTL ? 'rotate-180 group-hover:-translate-x-1' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                </a>
                <a href="#team" className={`group border-2 border-[#041533] text-[#041533] px-8 py-4 rounded-2xl font-semibold backdrop-blur-sm hover:bg-[#041533] hover:text-white hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2 ${isRTL ? 'flex-row-reverse' : ''}`}>
            ...
            >
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p className="hover:text-gray-900 transition-colors duration-300 p-4 hover:bg-gray-50 rounded-lg">
                  {t('about.aboutMerka.paragraph1')}
                </p>
                <p className="hover:text-gray-900 transition-colors duration-300 p-4 hover:bg-gray-50 rounded-lg">
                  {t('about.aboutMerka.paragraph2')}
                </p>
                <p className="hover:text-gray-900 transition-colors duration-300 p-4 hover:bg-gray-50 rounded-lg">
                  {t('about.aboutMerka.paragraph3')}
                </p>
              </div>
            </div>
            
            <div 
              className={`relative transition-all duration-1000 ease-out ${isRTL ? 'lg:col-start-1' : ''} ${
                scrollValue > 1200 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
              }`}
            ...
            >
              ...
              <div className="relative h-96 w-full rounded-2xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105 mb-8">
                ...
                <div className={`absolute bottom-4 ${isRTL ? 'right-4' : 'left-4'} text-white`}>
                  <p className="text-sm font-medium">{t('about.aboutMerka.ourDubaiStudio')}</p>
                </div>
              </div>

              <div className={`bg-gradient-to-br from-[#041533]/5 to-[#877051]/5 p-8 rounded-2xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-500 ${isRTL ? 'text-right' : ''}`}>
                <h3 className="text-2xl font-serif font-bold text-[#041533] mb-6">{t('about.aboutMerka.ourServices')}</h3>
                <ul className="space-y-4">
                  {(t('about.aboutMerka.services') || []).map((service, index) => (
                    <li key={index} className={`flex items-start group cursor-pointer ${isRTL ? 'flex-row-reverse' : ''}`}>
                      <div className={`w-3 h-3 bg-[#877051] rounded-full mt-2 ${isRTL ? 'ml-4' : 'mr-4'} flex-shrink-0 group-hover:scale-150 group-hover:bg-[#041533] transition-all duration-300`}></div>
                      <span className={`text-gray-700 group-hover:text-gray-900 transition-all duration-300 ${isRTL ? 'group-hover:-translate-x-2' : 'group-hover:translate-x-2'}`}>{service}</span>
                    </li>
                  ))}
                </ul>
              </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 relative z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className={`grid lg:grid-cols-2 gap-12 ${isRTL ? 'text-right' : ''}`}>
            {/* Vision Card */}
            <div 
            ...
            >
              <div className="bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl hover:-translate-y-4 transition-all duration-500 border border-gray-100 hover:border-[#877051]/30">
                <div className={`flex items-center mb-6 ${isRTL ? 'flex-row-reverse' : ''}`}>
                  <div className={`w-20 h-20 bg-gradient-to-r from-[#041533] to-[#877051] rounded-2xl flex items-center justify-center ${isRTL ? 'ml-4' : 'mr-4'} group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg`}>
                    <span className="text-white text-3xl">👁️</span>
                  </div>
                  <h3 className="text-3xl font-serif font-bold text-[#041533] group-hover:text-[#877051] transition-colors duration-300">{t('about.vision.title')}</h3>
                </div>
            ...
            >
              <div className="bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl hover:-translate-y-4 transition-all duration-500 border border-gray-100 hover:border-[#877051]/30">
                <div className={`flex items-center mb-6 ${isRTL ? 'flex-row-reverse' : ''}`}>
                  <div className={`w-20 h-20 bg-gradient-to-r from-[#877051] to-[#041533] rounded-2xl flex items-center justify-center ${isRTL ? 'ml-4' : 'mr-4'} group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg`}>
                    <span className="text-white text-3xl">🎯</span>
                  </div>
                  <h3 className="text-3xl font-serif font-bold text-[#041533] group-hover:text-[#877051] transition-colors duration-300">{t('about.mission.title')}</h3>
                </div>
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p className="hover:text-gray-900 transition-colors duration-300">
      ...
      <section id="founding-story" className="py-20 bg-white relative z-30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className={`bg-gradient-to-br from-gray-50 to-[#041533]/5 p-8 rounded-2xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-500 ${isRTL ? 'text-right' : ''}`}>
      ...
      <section id="team" className="py-20 bg-gradient-to-br from-gray-50 to-gray-100 relative z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className={`grid lg:grid-cols-3 gap-8 mb-12 ${isRTL ? 'text-right' : ''}`}>
            {[
              { icon: '🏗️', title: t('about.team.multidisciplinary'), desc: t('about.team.multidisciplinaryDesc'), gradient: 'from-[#041533] to-[#877051]' },
              { icon: '☁️', title: t('about.team.cloudBased'), desc: t('about.team.cloudBasedDesc'), gradient: 'from-[#877051] to-[#041533]' },
              { icon: '✅', title: t('about.team.qualityAssurance'), desc: t('about.team.qualityAssuranceDesc'), gradient: 'from-[#041533] to-[#877051]' }
            ].map((item, index) => (
              <div 
                key={index} 
          ...
          >
            <div className="bg-black/30 backdrop-blur-md p-8 rounded-3xl border-2 border-white/20 shadow-2xl">
              <h3 className="text-4xl font-serif font-bold text-white mb-6">
                {t('about.dubaiExpertise.title')}
              </h3>
              <p className={`text-xl text-gray-200 mb-8 leading-relaxed ${isRTL ? 'text-right' : ''}`}>
                {t('about.dubaiExpertise.description')}
              </p>
              <a href="#dubai-expertise" className={`group inline-flex items-center gap-2 bg-white text-[#041533] px-10 py-5 rounded-2xl font-semibold text-lg shadow-xl hover:bg-gray-50 hover:scale-105 hover:shadow-2xl transition-all duration-300 ${isRTL ? 'flex-row-reverse' : ''}`}>
                {t('about.dubaiExpertise.learnMore')}
      ...
      <section id="dubai-expertise" className="py-20 bg-gradient-to-br from-[#041533] via-[#2f3541] to-[#877051] text-white relative z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className={`text-xl text-gray-200 max-w-4xl mx-auto ${isRTL ? 'text-right' : ''}`}>
              {t('about.dubaiExpertise.description')}
            </p>
          </div>

          <div className={`grid lg:grid-cols-2 gap-12 mb-16 ${isRTL ? 'direction-rtl' : ''}`}>
            <div 
              className={`space-y-6 transition-all duration-1000 ease-out ${
                scrollValue > 4400 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'
              }`}
            >
              <h3 className={`text-2xl font-serif font-bold text-white mb-4 ${isRTL ? 'text-right' : ''}`}>{t('about.dubaiExpertise.specializedAreas')}</h3>
              <div className="space-y-4">
                {(t('about.dubaiExpertise.areas') || []).map((item, index) => (
                  <div key={index} className={`bg-white/10 backdrop-blur-sm p-4 rounded-lg border border-white/20 hover:bg-white/20 hover:border-white/40 hover:scale-105 transition-all duration-300 group cursor-pointer ${isRTL ? 'text-right' : ''}`}>
            ...
            <div 
              ...
              style={{ transitionDelay: '200ms' }}
            >
              <h3 className={`text-2xl font-serif font-bold text-white mb-4 ${isRTL ? 'text-right' : ''}`}>{t('about.dubaiExpertise.guidanceTitle')}</h3>
              <div className="grid grid-cols-1 gap-3">
                {(t('about.dubaiExpertise.guidance') || []).map((item, index) => (
                  <div key={index} className={`flex items-center group cursor-pointer p-2 hover:bg-white/10 rounded-lg transition-colors duration-300 ${isRTL ? 'flex-row-reverse' : ''}`}>
                    <div className={`w-3 h-3 bg-[#877051] rounded-full group-hover:scale-150 group-hover:bg-white transition-all duration-300 ${isRTL ? 'ml-3' : 'mr-3'}`}></div>
                    <span className={`text-gray-200 group-hover:text-white transition-all duration-300 ${isRTL ? 'group-hover:-translate-x-2' : 'group-hover:translate-x-2'}`}>{item}</span>
                  </div>
                ))}
              </div>
              
              <div className={`bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20 mt-8 hover:bg-white/20 hover:border-white/40 hover:scale-105 transition-all duration-500 group ${isRTL ? 'text-right' : ''}`}>
                <p className="text-gray-200 italic group-hover:text-white transition-colors duration-300">
                  &quot;{t('about.dubaiExpertise.quote')}&quot;
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#877051] to-[#041533] relative z-30">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className={`text-xl text-gray-200 mb-8 max-w-2xl mx-auto ${isRTL ? 'text-right' : ''}`}>
              {t('about.cta.description')}
            </p>
            <div className={`flex flex-col sm:flex-row gap-6 justify-center px-4 ${isRTL ? 'sm:flex-row-reverse' : ''}`}>
              <Link href="/contact" className={`group inline-flex items-center justify-center gap-2 bg-white text-[#041533] px-8 py-4 sm:px-10 sm:py-5 rounded-2xl font-semibold text-base sm:text-lg shadow-xl hover:bg-gray-50 hover:scale-105 hover:shadow-2xl transition-all duration-300 ${isRTL ? 'flex-row-reverse' : ''}`}>
                {t('about.cta.startProject')}
                <svg className={`w-5 h-5 transition-transform duration-300 ${isRTL ? 'rotate-180 group-hover:-translate-x-1' : 'group-hover:translate-x-1'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
              </Link>
              <Link href="/projects" className={`group inline-flex items-center justify-center gap-2 border-2 border-white text-white px-8 py-4 sm:px-10 sm:py-5 rounded-2xl font-semibold text-base sm:text-lg backdrop-blur-sm hover:bg-white hover:text-[#041533] hover:scale-105 transition-all duration-300 ${isRTL ? 'flex-row-reverse' : ''}`}>
